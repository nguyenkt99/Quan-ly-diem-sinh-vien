...
{
    public partial class Frpt_INBANGDIEMTONGKET : Form
    {
        public Frpt_INBANGDIEMTONGKET()
        {
            InitializeComponent();
        }

        private void Frpt_INBANGDIEMTONGKET_Load(object sender, EventArgs e)
        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            Xrpt_INBANGDIEMTONGKET rpt = new Xrpt_INBANGDIEMTONGKET(maLop);
