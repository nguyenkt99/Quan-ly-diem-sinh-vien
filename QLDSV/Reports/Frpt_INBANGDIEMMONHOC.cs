...
{
    public partial class Frpt_INBANGDIEMMONHOC : Form
    {
        public Frpt_INBANGDIEMMONHOC()
        {
            InitializeComponent();
        }

        private void Frpt_INBANGDIEMMONHOC_Load(object sender, EventArgs e)
        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            Xrpt_INBANGDIEMMONHOC rpt = new Xrpt_INBANGDIEMMONHOC(maLop, maMH, lanThi);
